...
object Settings {
    enum class MenuTag(val titleId: Int = 0) {
        ...
        SECTION_INPUT_PLAYER_ONE(1),
        SECTION_INPUT_PLAYER_TWO(2),
        SECTION_INPUT_PLAYER_THREE(3),
        SECTION_INPUT_PLAYER_FOUR(4),
        SECTION_INPUT_PLAYER_FIVE(5),
        SECTION_INPUT_PLAYER_SIX(6),
        SECTION_INPUT_PLAYER_SEVEN(7),
        SECTION_INPUT_PLAYER_EIGHT(8),
